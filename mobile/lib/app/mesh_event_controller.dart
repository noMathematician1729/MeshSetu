...
class MeshEventController {
  ...
  bool _ownsReturnDatabase = false;
  ...
  Future<void> start() async {
    ...
    try {
      ...
      ownsReturnDatabase = database == null;
      _returnDatabase = returnDb;
      _ownsReturnDatabase = ownsReturnDatabase;
      ...
      if (ownsReturnDatabase) await returnDatabase?.close();
      _returnDatabase = null;
      _ownsReturnDatabase = false;
      _returnRouter = null;
      try {
  ...
  Future<void> stop() async {
    ...
    _returnDatabase = null;
    final ownsReturnDatabase = _ownsReturnDatabase;
    _ownsReturnDatabase = false;
    _returnRouter = null;
