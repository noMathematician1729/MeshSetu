...
final class GatewayDownlinkPoller {
  ...
  Future<void> uploadReadyReceipts() async {
    if (!_running) return;
    ...
    final future = _uploadReadyReceiptsSafely();
  ...
  Future<void> _uploadReadyReceiptsSafely() async {
    try {
      ...
      // The receipt remains READY. This loop is advisory to BLE delivery and
      // must never surface a transient gateway failure as an unhandled error.
    }
  }
